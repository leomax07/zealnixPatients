...
export const API_FAIL =
  'Service not available at moment. Sorry for Inconvenience';

export const USER_PROFILE = 'https://i.ibb.co/gD8QHWk/image-1474.png';
// export const USER_PROFILE = 'https://i.ibb.co/yyttZz0/user.png';

export const COVER_IMAGE = 'https://i.ibb.co/CQGtMpR/Group-627200.png';
